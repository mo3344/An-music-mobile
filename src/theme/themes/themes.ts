...
export default [
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(23, 206, 141)",
        "c-primary-dark-100": "rgb(21,185,127)",
        "c-primary-dark-100-alpha-100": "rgba(21, 185, 127, 0.90)",
        "c-primary-alpha-100": "rgba(23, 206, 141, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(21, 185, 127, 0.80)",
        "c-primary-alpha-200": "rgba(23, 206, 141, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(21, 185, 127, 0.70)",
        "c-primary-alpha-300": "rgba(23, 206, 141, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(21, 185, 127, 0.60)",
        "c-primary-alpha-400": "rgba(23, 206, 141, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(21, 185, 127, 0.50)",
        "c-primary-alpha-500": "rgba(23, 206, 141, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(21, 185, 127, 0.40)",
        "c-primary-alpha-600": "rgba(23, 206, 141, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(21, 185, 127, 0.30)",
        "c-primary-alpha-700": "rgba(23, 206, 141, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(21, 185, 127, 0.20)",
        "c-primary-alpha-800": "rgba(23, 206, 141, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(21, 185, 127, 0.10)",
        "c-primary-alpha-900": "rgba(23, 206, 141, 0.10)",
        "c-primary-dark-200": "rgb(19,167,114)",
        "c-primary-dark-200-alpha-100": "rgba(19, 167, 114, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(19, 167, 114, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(19, 167, 114, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(19, 167, 114, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(19, 167, 114, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(19, 167, 114, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(19, 167, 114, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(19, 167, 114, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(19, 167, 114, 0.10)",
        "c-primary-dark-300": "rgb(17,150,103)",
        "c-primary-dark-300-alpha-100": "rgba(17, 150, 103, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(17, 150, 103, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(17, 150, 103, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(17, 150, 103, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(17, 150, 103, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(17, 150, 103, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(17, 150, 103, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(17, 150, 103, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(17, 150, 103, 0.10)",
        "c-primary-dark-400": "rgb(15,135,93)",
        "c-primary-dark-400-alpha-100": "rgba(15, 135, 93, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(15, 135, 93, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(15, 135, 93, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(15, 135, 93, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(15, 135, 93, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(15, 135, 93, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(15, 135, 93, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(15, 135, 93, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(15, 135, 93, 0.10)",
        "c-primary-dark-500": "rgb(14,122,84)",
        "c-primary-dark-500-alpha-100": "rgba(14, 122, 84, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(14, 122, 84, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(14, 122, 84, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(14, 122, 84, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(14, 122, 84, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(14, 122, 84, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(14, 122, 84, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(14, 122, 84, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(14, 122, 84, 0.10)",
        "c-primary-dark-600": "rgb(13,110,76)",
        "c-primary-dark-600-alpha-100": "rgba(13, 110, 76, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(13, 110, 76, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(13, 110, 76, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(13, 110, 76, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(13, 110, 76, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(13, 110, 76, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(13, 110, 76, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(13, 110, 76, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(13, 110, 76, 0.10)",
        "c-primary-dark-700": "rgb(12,99,68)",
        "c-primary-dark-700-alpha-100": "rgba(12, 99, 68, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(12, 99, 68, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(12, 99, 68, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(12, 99, 68, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(12, 99, 68, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(12, 99, 68, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(12, 99, 68, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(12, 99, 68, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(12, 99, 68, 0.10)",
        "c-primary-dark-800": "rgb(11,89,61)",
        "c-primary-dark-800-alpha-100": "rgba(11, 89, 61, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(11, 89, 61, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(11, 89, 61, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(11, 89, 61, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(11, 89, 61, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(11, 89, 61, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(11, 89, 61, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(11, 89, 61, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(11, 89, 61, 0.10)",
        "c-primary-dark-900": "rgb(10,80,55)",
        "c-primary-dark-900-alpha-100": "rgba(10, 80, 55, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(10, 80, 55, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(10, 80, 55, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(10, 80, 55, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(10, 80, 55, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(10, 80, 55, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(10, 80, 55, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(10, 80, 55, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(10, 80, 55, 0.10)",
        "c-primary-dark-1000": "rgb(9,72,50)",
        "c-primary-dark-1000-alpha-100": "rgba(9, 72, 50, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(9, 72, 50, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(9, 72, 50, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(9, 72, 50, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(9, 72, 50, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(9, 72, 50, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(9, 72, 50, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(9, 72, 50, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(9, 72, 50, 0.10)",
        "c-primary-light-100": "rgb(69,216,164)",
        "c-primary-light-100-alpha-100": "rgba(69, 216, 164, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(69, 216, 164, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(69, 216, 164, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(69, 216, 164, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(69, 216, 164, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(69, 216, 164, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(69, 216, 164, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(69, 216, 164, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(69, 216, 164, 0.10)",
        "c-primary-light-200": "rgb(106,224,182)",
        "c-primary-light-200-alpha-100": "rgba(106, 224, 182, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(106, 224, 182, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(106, 224, 182, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(106, 224, 182, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(106, 224, 182, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(106, 224, 182, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(106, 224, 182, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(106, 224, 182, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(106, 224, 182, 0.10)",
        "c-primary-light-300": "rgb(136,230,197)",
        "c-primary-light-300-alpha-100": "rgba(136, 230, 197, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(136, 230, 197, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(136, 230, 197, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(136, 230, 197, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(136, 230, 197, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(136, 230, 197, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(136, 230, 197, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(136, 230, 197, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(136, 230, 197, 0.10)",
        "c-primary-light-400": "rgb(160,235,209)",
        "c-primary-light-400-alpha-100": "rgba(160, 235, 209, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(160, 235, 209, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(160, 235, 209, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(160, 235, 209, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(160, 235, 209, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(160, 235, 209, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(160, 235, 209, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(160, 235, 209, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(160, 235, 209, 0.10)",
        "c-primary-light-500": "rgb(179,239,218)",
        "c-primary-light-500-alpha-100": "rgba(179, 239, 218, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(179, 239, 218, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(179, 239, 218, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(179, 239, 218, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(179, 239, 218, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(179, 239, 218, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(179, 239, 218, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(179, 239, 218, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(179, 239, 218, 0.10)",
        "c-primary-light-600": "rgb(194,242,225)",
        "c-primary-light-600-alpha-100": "rgba(194, 242, 225, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(194, 242, 225, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(194, 242, 225, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(194, 242, 225, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(194, 242, 225, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(194, 242, 225, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(194, 242, 225, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(194, 242, 225, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(194, 242, 225, 0.10)",
        "c-primary-light-700": "rgb(206,245,231)",
        "c-primary-light-700-alpha-100": "rgba(206, 245, 231, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(206, 245, 231, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(206, 245, 231, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(206, 245, 231, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(206, 245, 231, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(206, 245, 231, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(206, 245, 231, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(206, 245, 231, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(206, 245, 231, 0.10)",
        "c-primary-light-800": "rgb(216,247,236)",
        "c-primary-light-800-alpha-100": "rgba(216, 247, 236, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(216, 247, 236, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(216, 247, 236, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(216, 247, 236, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(216, 247, 236, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(216, 247, 236, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(216, 247, 236, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(216, 247, 236, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(216, 247, 236, 0.10)",
        "c-primary-light-900": "rgb(224,249,240)",
        "c-primary-light-900-alpha-100": "rgba(224, 249, 240, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(224, 249, 240, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(224, 249, 240, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(224, 249, 240, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(224, 249, 240, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(224, 249, 240, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(224, 249, 240, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(224, 249, 240, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(224, 249, 240, 0.10)",
        ...
        "c-750": "rgb(77,78,82)",
        "c-700": "rgb(88,90,93)",
        "c-650": "rgb(100,102,105)",
        "c-600": "rgb(112,113,116)",
        "c-550": "rgb(124,125,128)",
        "c-500": "rgb(136,137,140)",
        "c-450": "rgb(148,149,151)",
        "c-400": "rgb(160,161,163)",
        "c-350": "rgb(172,172,174)",
        "c-300": "rgb(184,184,186)",
        "c-250": "rgb(196,196,197)",
        "c-200": "rgb(207,208,209)",
        "c-150": "rgb(219,220,220)",
        "c-100": "rgb(231,231,232)",
