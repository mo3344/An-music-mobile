...
export default memo(() => {
  ...
  const t = useI18n()
  const openHomePage = () => {
    void openUrl('https://github.com/mo3344/An-music-mobile#readme')
  }
  const openIssuePage = () => {
    void openUrl('https://github.com/mo3344/An-music-mobile/issues?q=is%3Aissue+')
  }
  const openGHReleasePage = () => {
    void openUrl('https://github.com/mo3344/An-music-mobile/releases')
  }
  const openFAQPage = () => {
    void openUrl('https://github.com/mo3344/An-music-mobile/blob/master/FAQ.md')
  }
  const openPactModal = () => {
    showPactModal()
  }
    ...
    <Section title={t('setting_about')}>
      <View style={styles.part}>
        ...
        <TouchableOpacity onPress={openHomePage}>
          <Text style={textLinkStyle}>https://github.com/mo3344/An-music-mobile</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.part}>
